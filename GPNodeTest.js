...
nconf.defaults({
     ...
     'nelite':20,
     'ngenerations':100,
     'minfofx':-20.807653775815012, //these need to be generated by a call to getStatsForRule
     'maxfofx':14.98809512542047,
...
var node=require("./GPNode");


var rule=[ "-","*","-","if<=","speed1","going2",-6.8351,-2.6192,"^","going2",0.1175,"/","/","goingdiff",-1.6873,"-","/","+",-1.4090,"speed1","^","going1","speed1","if<=","+",-1.4090,9.2973,"if<=","going2","/","if<=","-","/","+",-1.4090,"speed1","^","going1","going2","if<=","speed1","if<=","going2","/","if<=","going2","going1","speed1",4.4473,"if<=","speed1",-5.8824,-1.4090,"going2",-8.9986,"speed1","*",1.2560,-8.9996,9.1184,"going1","speed1",4.4473,"if<=","speed1",-5.8824,-1.4090,"going2",-8.9986,"+","*","/","goingdiff",-1.6873,"+",-1.6873,"speed1","*","/","^",9.2973,"speed1","/",-0.1335,-4.6932,"-","-","*","-","if<=",-8.9986,"+",-7.8231,"*",1.2560,"if<=","going2","if<=","going2","/","/","+",-1.4090,"speed1","going1","if<=","speed1",-5.8824,-1.4090,"going2",-8.9986,"+","*","if<=","speed1","+",-7.8231,"*",1.2560,-8.9996,"+","going2",9.4690,"speed1","+",-1.6873,"speed1",-1.4090,"*",1.2560,-8.9996,9.1184,"+","going2","goingdiff","speed1",-2.6192,"if<=","*","goingdiff",8.6207,"if<=","going1","going2","/","/","goingdiff",-1.6873,"-","/","+",-1.4090,9.2973,"^","going2",0.1175,"+","going1","going1","going1","/","going2","going1","going2",-8.9986,"if<=","goingdiff","going1","going1","if<=","going2","going1",-8.9986,"speed1","*",1.2560,-8.9996,9.1184,"/","goingdiff",-1.2860];
//var rule=["-","+","distancediff","*","goingdiff","if<=","weightdiff","distance2","weight2","-","*",3.4309,"goingdiff","distancediff","if<=","if<=","going1","if<=","weight2","distancediff","goingdiff","distance2","-","-","+","distancediff","*","goingdiff","if<=","weightdiff","distance2","weight2","*",3.4309,"goingdiff","distance1","weightdiff","distancediff","weight1","going1","distancediff"];
...
var observation={"speed1":16.24880956959883,"speed2":17.3041683220497,"datediff":0,"going1":-2,"going2":2,"goingdiff":4,"distance1":1400.00,"distance2":1400.00,"distancediff":0.0,"weight1":130,"weight2":130,"weightdiff":0,"_id":"56d964ef9c96d60c22fbf2b6"}

var testNode=new node().parseNode(rule,nconf.get('variables'),nconf.get('functionSet'));
...
console.log(val + 'predictedProportion: ' + predictedProportion + ' predictedChange: ' + predictedChange + ' predictedSpeed: ' + predictedSpeed);
